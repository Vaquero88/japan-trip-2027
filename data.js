const TRIP = {
  ...
  flightGroups: {
    outbound: {
      title:"Vuelo de ida",
      date:"17–18 mayo 2027",
      total:"21 h 05 min de viaje",
      layover:"Escala en Chengdu · 4 h 15 min",
      segments:[0,1]
    },
    return: {
      title:"Vuelo de vuelta",
      date:"31 mayo 2027",
      total:"18 h 55 min de viaje",
      layover:"Escala en Pekín · 3 h 35 min",
      segments:[2,3]
    }
  },
  stays: [
  ...
  expenses: [
    {category:"Alojamiento", place:"Tokio", description:"Alojamiento en Taito City", amount:775.90},
    {category:"Alojamiento", place:"Hakone", description:"Fukuzumiro · Sakura #5 + Sakura #6", amount:890.22},
    {category:"Alojamiento", place:"Kioto", description:"Alojamiento en Minami-ku", amount:617.17},
    {category:"Alojamiento", place:"Osaka", description:"Alojamiento en Naniwa Ward", amount:130.57},
    {category:"Seguro de viaje", place:"Viaje completo", description:"Seguro Intermundial · 4 personas", amount:335.45},
    {category:"Vuelos de ida", place:"Madrid → Chengdu → Tokio", description:"4 personas · Sichuan Airlines", amount:1312.00},
    {category:"Vuelos de vuelta", place:"Osaka → Pekín → Madrid", description:"4 personas · Air China", amount:1841.00},
